...
- Covered backend surface: health/readiness, current user, product policy, roles, navigation, dashboard, appointments, queue, pets, pet documents, prescriptions, clinical reads and note workflows, lab diagnostics, billing reads and invoice mutations, analytics, feedback, doctors, staff management, and audit log review.
