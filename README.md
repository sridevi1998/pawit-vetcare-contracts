...
- Covered backend surface: health/readiness, current user, product policy, roles, navigation, dashboard, appointments, queue, pets, pet documents, prescriptions, clinical reads, lab diagnostics, billing reads and invoice mutations, analytics, feedback, doctors, and staff management.
